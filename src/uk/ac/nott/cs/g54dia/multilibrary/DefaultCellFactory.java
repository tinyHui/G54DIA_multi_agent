...
public class DefaultCellFactory implements CellFactory {
    ...
    public void generateCell(Environment env, Point pos) {
		...
		// Commented out by Lavindra on 5 March 2015
		// so that the 'stations' attribute can be
		// made private within the 'Environment' class
		
    		// env.stations.add((Station)env.getCell(pos));
    		
    		env.addStation((Station)env.getCell(pos));
    	}
    	else {
